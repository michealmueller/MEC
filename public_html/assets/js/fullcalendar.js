...
(function (t) {
    ...
    function me(n, r) {
        ...
        function f(n) {
            ...
            var r, s, l, a, u, d = Q.defaultButtonText || {}, c = Q.buttonText || {}, h = Q.views || {}, f = n, g = [],
                p = !1;
            if (he[n]) return he[n];
        ...
        var ee, ne, ie, re, se, oe, le, ae, ue = q.isFetchNeeded, de = q.fetchEvents, ce = n[0], he = {}, fe = 0,
            ge = [];
    ...
    function ye(n) {
        ...
        function o(e, i) {
            ...
            if (a) t.isFunction(a) ? (y(), a.call(O, B.clone(), Z.clone(), n.timezone, function (t) {
                ...
                if (u) {
                    ...
                    var g = t.extend({}, d || {}), p = F(e.startParam, n.startParam), m = F(e.endParam, n.endParam),
        ...
        function L(t, e) {
            var i = e.source || {}, r = F(e.constraint, i.constraint, n.eventConstraint),
        ...
        var B, Z, I = O.trigger, W = O.getView, j = O.reportEvents, X = {events: []}, $ = [X], U = 0, q = 0, K = 0,
            Q = [];
    ...
    }, De = t.fullCalendar = {version: "2.2.7"}, Ce = De.views = {};
    ...
    var xe = {
        defaultButtonText: function (t) {
            return {prev: _(t.prevText), next: _(t.nextText), today: _(t.currentText)}
    ...
    var Re, ke, Me, Fe = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        ze = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], _e = {}.hasOwnProperty,
        Le = /^\s*\d{4}-\d\d$/,
        Pe = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
        Ve = e.fn, Ge = t.extend({}, Ve);
    De.moment = function () {
        return A(arguments)
    ...
    var Oe = K.extend({
        ...
        position: function () {
            var e, n, i, r, s, o = this.options, l = this.el.offsetParent().offset(), a = this.el.outerWidth(),
                u = this.el.outerHeight(), d = t(window), c = p(this.el);
        ...
        fillSegHtml: function (t, e) {
            var n = this[t + "SegClasses"], i = this[t + "SegStyles"], r = n ? n.call(this, e) : [],
                s = i ? i.call(this, e) : "";
    ...
    Xe.mixin({
        mousedOverSeg: null, isDraggingSeg: !1, isResizingSeg: !1, segs: null, renderEvents: function (t) {
            ...
            var e = this.view, n = t.event, i = n.source || {}, r = n.color, s = i.color, o = e.opt("eventColor"),
            ...
            var e = this.view, n = t.source || {}, i = t.color, r = n.color, s = e.opt("eventColor"),
                ...
                a = t.textColor || n.textColor || e.opt("eventTextColor"), u = [];
    ...
    var $e = Xe.extend({
        ...
        computeCellRange: function (t) {
            var e = this.colCnt, n = t.row * e + (this.isRTL ? e - t.col - 1 : t.col), i = this.cellDates[n].clone(),
                r = i.clone().add(1, "day");
    ...
    $e.mixin({
        rowStructs: null, destroyEvents: function () {
            ...
            var n, i = this.view, r = t.event, s = i.isEventDraggable(r),
                o = !e && r.allDay && t.isEnd && i.isEventResizable(r), l = this.getSegClasses(t, s, o),
                a = this.getEventSkinCss(r), u = "";
        ...
        segPopover: null, popoverSegs: null, destroySegPopover: function () {
            ...
            return t('<a class="fc-more"/>').text(this.getMoreLinkText(n.length)).on("click", function (s) {
                var o = r.opt("eventLimitClick"), l = e.start, a = t(this), u = i.getCellDayEl(e), d = i.getCellSegs(e),
                    c = i.resliceDaySegs(d, l), h = i.resliceDaySegs(n, l);
    ...
    var Ue = Xe.extend({
        ...
        computeCellRange: function (t) {
            var e = this.computeSnapTime(t.row), n = this.view.calendar.rezoneDate(t.day).time(e),
    ...
    Ue.mixin({
        eventSkeletonEl: null, renderFgSegs: function (e) {
            ...
            var n, i, r, s = this.view, o = t.event, l = s.isEventDraggable(o),
                a = !e && t.isEnd && s.isEventResizable(o), u = this.getSegClasses(t, l, a),
    ...
    var qe = De.View = K.extend({
        ...
        computeRange: function (t) {
            var n, i, r = e.duration(this.opt("duration") || this.constructor.duration || {days: 1}), s = b(r),
                o = t.clone().startOf(s), l = o.clone().add(r);
